...
import {RwaOutputConduit4} from "./RwaOutputConduit4.sol";
...
contract RwaOutputConduit4Test is Test, DSMath {
    address me;
    ...
    function setUp() public {
        ...
        testUrn = vm.addr(420);
        outputConduit = new RwaOutputConduit4(address(dai), address(usdx), address(psm));
    ...
    function testSetWardAndEmitRelyOnDeploy() public {
        ...
        RwaOutputConduit4 c = new RwaOutputConduit4(address(dai), address(usdx), address(psm));
    ...
    function testRevertOnGemUnssuportedDecimals() public {
        ...
        new RwaOutputConduit4(address(dai), address(testGem), address(psmT));
    }

    function testRevertInvalidConstructorArguments() public {
        vm.expectRevert();
        new RwaOutputConduit4(address(0), address(0), address(0));

        vm.expectRevert("RwaOutputConduit4/wrong-dai-for-psm");
        new RwaOutputConduit4(address(0), address(usdx), address(psm));

        vm.expectRevert("RwaOutputConduit4/wrong-gem-for-psm");
        new RwaOutputConduit4(address(dai), address(0), address(psm));
    }
    ...
    function testRevertOnPushWhenToAddressNotPicked() public {
        ...
        vm.expectRevert("RwaOutputConduit4/to-not-picked");
        c.push();
    }
    ...
    function testRevertOnFileUnrecognisedParam() public {
        vm.expectRevert("RwaOutputConduit4/unrecognised-param");
    ...
    function testRevertOnUnauthorizedMethods() public {
        ...
        vm.expectRevert("RwaOutputConduit4/not-authorized");
        outputConduit.rely(address(0));
    ...
    function testRevertOnNotMateMethods() public {
        ...
        vm.expectRevert("RwaOutputConduit4/not-mate");
        outputConduit.quit();
    }
    ...
    function testRevertOnNotOperatorMethods() public {
        ...
        vm.expectRevert("RwaOutputConduit4/not-operator");
        outputConduit.pick(address(0));
    }

    function testRevertOnPickAddressNotWhitelisted() public {
        vm.expectRevert("RwaOutputConduit4/not-bud");
    ...
    function testRevertOnPushAmountMoreThenBalance() public {
        ...
        vm.expectRevert("RwaOutputConduit4/insufficient-swap-gem-amount");
    ...
    function testRevertOnQuitWhenQuitToAddressNotSet() public {
        ...
        vm.expectRevert("RwaOutputConduit4/invalid-quit-to-address");
        outputConduit.quit();
    }
